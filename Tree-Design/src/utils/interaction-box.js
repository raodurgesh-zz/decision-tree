...
export default class Interaction extends Component {
  ...
  render() {
    ...
    const removeButton = this.props.showRemoveButton && (
      <i className="fa fa-times" onClick={removeNode} aria-hidden="true" />
    );

    const inputBox = (
      <div className="input-box">
        <input
          placeholder="Type interaction name"
          ref={comp => (this.inputBox = comp)}
          autoFocus="true"
    ...
    return (
      <div className="interaction-wrapper">
        ...
        <div className="button pull-right">
          {' '}
          {removeButton}{' '}
          <i className="fa fa-check" aria-hidden="true" onClick={createNode} />
        </div>
        {el}
      </div>
    );
